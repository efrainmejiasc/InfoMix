<%@ Page Title="" Language="C#" MasterPageFile="~/_Login.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="RegistroTransacciones.Login" %>
    ...
    <asp:UpdatePanel ID="upPrincipal" runat="server">
        <ContentTemplate>
            <div align="center">
                ...
                <br />
                <br />
                <asp:Label ID="lblVersion" runat="server" CssClass="lblFooter" meta:resourcekey="lblVersion">Version 3.5.1</asp:Label>
                <%--PANEL MENSAJE--%>
